...
if (BOOST_USE_CPP11)
    ...
    elseif(UNIX)
        if(APPLE)
            # TODO(lixianliang): Clang
        else()
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++0x")
            set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -include \"${FB_BOOST_USE_CPP11_DIR}/internal/all_in_one.hpp\"")
        endif()
    endif()
else()
    if (MSVC11)
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /DBOOST_CHRONO_HEADER_ONLY")
    elseif()
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DBOOST_CHRONO_HEADER_ONLY")
    endif()
endif()
