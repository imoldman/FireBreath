...
macro (makesure_boost_dir)
    if (BOOST_USE_CPP11)
        list(APPEND Boost_USE_CPP11_INCLUDE_DIRS ${FB_BOOST_USE_CPP11_DIR})
        list(REMOVE_DUPLICATES Boost_USE_CPP11_INCLUDE_DIRS)
    endif()
...
macro (export_project_dependencies)
    ...
    set (Boost_USE_CPP11_INCLUDE_DIRS ${Boost_USE_CPP11_INCLUDE_DIRS} PARENT_SCOPE)
...
function (fb_wisp_boost_use_cpp11)
    add_subdirectory(${FB_BOOST_USE_CPP11_DIR} ${CMAKE_BINARY_DIR}/boost-use-cpp11)
endfunction()
